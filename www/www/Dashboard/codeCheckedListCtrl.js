gulf.controller("CodeCheckedInCtrl", function ($scope, $rootScope, $http, TransactionService, AppService, $state, HeaderService, $ionicPopup, $ionicPlatform, AddMechanicService, LoaderService, ConverBase64) {
    ...
    $(document).ready(function (e) {
        $('#areaCodeCheckedin').select2({
            dropdownParent: $('#parentAreaCodeCheckedin')
        });
        $('#soListCode').select2({
            dropdownParent: $('#parentSoListCode')
        });
        $('#thListCode').select2({
            dropdownParent: $('#parentThListCode')
        });
        $('#ahListCode').select2({
            dropdownParent: $('#parentAhListCode')
        });
    });
...
*/
    ...
    $("#fromdateCodeChechckedList").datepicker({
    ...
    $("#todateCodeChechckedList").datepicker({
    ...
    $scope.search = function () {
        ...
        $('#activeMechnaic').DataTable({
            ...
            "ajax": {
                url: AppService.url + "api_r3/public/getSODetailedMechDetails?soId=" + $rootScope.userID + "&status=CodesChecked&fromDate=" + $scope.fromdate + "&toDate=" + $scope.todate + "&areaName=" + $scope.data.selectedAreaIncheckedIn + "&soFilter=" + selectedSOId + "&thFilter=" + selecteduserThId + "&ahFilter=" + selecteduserAHId + "&token=" + token,
                "type": "GET",
                dataType: "json",
    ...
    try {
        if (AppService.enableTracking) {
            _paq.push(['setDocumentTitle', "Code Checked In Page"]);
