gulf.controller('BankDetailListCtrl', function ($scope, NonMlpServices, LoaderService, $rootScope, ConverBase64, $ionicPopup, $state, HeaderService, AppService, $cordovaInAppBrowser) {
    ...
    try {
        if (AppService.enableTracking) {
            _paq.push(['setDocumentTitle', "Non MLP Bank Detail List Page"]);
