...
gulf.controller('TransactionReportNonMlpCtrl', function ($scope, TransactionService, $rootScope, $state, HeaderService, LoaderService, $ionicPopup, $location, $anchorScroll, AppService, NonMlpServices, ConverBase64) {
    $scope.fromdate = "";
    $scope.todate = "";
    ...
    $scope.transactionReport = function () {
        ...
        $('#transactionReportTableNonMlp').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "ucr_credited_on" // "code"   // changed on Apr13th - fh043
                },
                {
                    "data": "code"
                },
                ...
                {
                    "data": "ucr_amount"  // "pdct_desc"  // changed on Apr13th - fh043
                }
    ...
    try {
        if (AppService.enableTracking) {
            _paq.push(['setDocumentTitle', "Non MLP Transaction Report Page"]);
