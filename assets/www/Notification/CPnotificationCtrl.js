gulf.controller("CPNotificationCtrl", function ($scope, $state, $rootScope, ConverBase64, DashboardService, LoaderService, AppService, TransactionService, HeaderService, $ionicPopup, $rootScope) {
