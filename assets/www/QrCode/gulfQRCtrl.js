gulf.controller('GulfQrCtrl', function ($scope, $state, $rootScope, $ionicPopup, $cordovaBarcodeScanner, $ionicPlatform, CodeCheckInService, $ionicPopup, LoaderService, HeaderService, AppService, LoginService, PanUpdateService) {
