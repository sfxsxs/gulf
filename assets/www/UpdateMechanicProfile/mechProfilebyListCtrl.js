gulf.controller("mechProfilebyListCtrl", function ($scope, $state, $rootScope, ConverBase64, AddMechanicService, $ionicPopup, LoginService, LoaderService, UpdateMechanicProfileService, HeaderService, AppService, $ionicPlatform, $cordovaCamera, $cordovaFileTransfer, $location, $anchorScroll, CodeCheckInService, $stateParams) {
    ...
    //userData && userData.user_category=="Loyalty User"
...
*/
    ...
    $scope.uploadProfilePhotoToServer = function () {
        ...
        // Destination URL
        // var url = "http://labs.firsthive.com/princepipes_v3/api/public/profilepicupload";
