gulf.controller('SelectLanguageCtrl', function ($scope, $state, $rootScope, ConverBase64, $ionicPopup, LoaderService, $cordovaDevice, $ionicPlatform, AppService, NonMlpServices) {
    ...
    try {
        if (AppService.enableTracking) {
            _paq.push(['setDocumentTitle', "Select Language Page"]);
