gulf.controller('referralReportNonMLPCtrl', function ($scope, $ionicPopup, $rootScope, AddMechanicService, ReferFriendService, $state, ConverBase64, HeaderService, LoaderService, AppService) {
    ...
    $scope.referlReportNonMLP = function () {
