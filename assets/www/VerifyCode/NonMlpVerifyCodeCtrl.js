gulf.controller('NonMlpVerifyCodeCtrl', function ($scope, $state, $rootScope, $ionicPopup, $cordovaBarcodeScanner, $ionicPlatform, CodeVerificationservice, HeaderService, AppService, LoginService) {
    ...
    $scope.submitQrCodeData = function () {
        CodeVerificationservice.codeVerification($scope.QrCodeData).then(function (result) {
            ...
            if (result.Status == true) {
                ...
                $state.go('NonMlpVerifyCodeResult');
